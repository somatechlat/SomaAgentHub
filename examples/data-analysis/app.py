...
class DataAnalysisAgent:
    ...
    async def _show_summary(self):
        ...
        console.print(
            Panel(result.get("output", ""), title="AI Insights", border_style="green")
        )
    ...
    async def _analyze_column(self):
        ...
        console.print(
            Panel(
                result.get("output", ""), title="Column Analysis", border_style="green"
            )
        )
    ...
    async def _get_viz_suggestions(self):
        ...
        column_types = {
            ...
            "categorical": [
                col
                for col in self.dataframe.columns
                if pd.api.types.is_object_dtype(self.dataframe[col])
            ],
            "datetime": [
                col
                for col in self.dataframe.columns
