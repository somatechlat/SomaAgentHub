        ...
        "
        gent_call_example.py` demonstrates a **real** end-to-end interaction with
        maAgentHub using the Python SDK. The flow keeps dependencies minimal so you
        n copy/paste it into your own automation scripts.
