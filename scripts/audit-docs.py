...
# Required metadata sections (used inline; no variable needed for lint)
...
print(
f"📋 Found {len(self.report['missing_metadata'])} files with missing metadata"
)
...
0.0, max_score - (total_penalty / total_files * 100)
)
