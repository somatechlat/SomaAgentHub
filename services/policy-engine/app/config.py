...
REDIS_URL = (
    resolve_env("POLICY_ENGINE_REDIS_URL")
    or resolve_env("REDIS_URL", "redis://redis:6379/0")
)

# OPA configuration
OPA_URL = (
    resolve_env("POLICY_ENGINE_OPA_URL")
    or resolve_env("OPA_URL", "http://localhost:8181")
)
...
class PolicyEngineConfig:
    ...
    def __init__(self):
        ...
        self.constitution_service_url = (
            resolve_env("CONSTITUTION_SERVICE_URL", "http://constitution-service:10024")
        )