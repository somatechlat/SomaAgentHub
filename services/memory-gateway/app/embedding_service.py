        dding service for text vectorization.

        orts multiple embedding models:
            - OpenAI ada-002
                                            ...
                                            def embed_text(self, text: str) -> list[float]:
                                                ...
                                                Args:
                                                    ...
                                                    Returns:
                                                        ...
                                                        """
                                                        if not text.strip():
                                                            turn zero vector for empty text
                                                                                                                                        ...
                                                                                                                                        Args:
                                                                                                                                            ...
                                                                                                                                            Returns:
                                                                                                                                                ...
                                                                                                                                                if norm1 == 0 or norm2 == 0:
                                                                                                                                                    ...
                                                                                                                                                    obal embedding service instance
