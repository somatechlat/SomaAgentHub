        ...
        -level autonomous project creation from simple prompts:
                                                        ...
                                                        if "python" in prompt_lower:
                                                            ...
                                                            if "typescript" in prompt_lower or "ts" in prompt_lower:
                                                                ...
                                                                if "react" in prompt_lower:
                                                                    ...
                                                                    e template if no preferences
                                                                    if not tech_stack:
                                                                        tech_stack = self.templates[project_type]["tech_stack"]

                                                                        tect infrastructure preferences
                                                                        infrastructure = {}
                                                                                        ...
                                                                                        if "postgres" in prompt_lower:
                                                                                            infrastructure["database"] = "PostgreSQL"
                                                                                                ...
                                                                                                infrastructure["database"] = "MongoDB"
                                                                                                    ...
                                                                                                    tract project name (simple heuristic)
            ...
            {
                "name": "main_db",
                "type": spec.infrastructure.get("database", "PostgreSQL").lower(),
            },
            ]
            ...
            Args:
                ...
                Returns:
                    ...
                    plan = {"project_name": spec.name, "execution_type": "dag", "steps": []}

                    ep 1: Infrastructure setup
                    plan["steps"].append(
                    {
            "id": "infra_setup",
            ...
            "parameters": {"title": f"{spec.name} - Documentation"},
            ...
            ample usage - requires real MAO client
