...
STATIC_TOKEN = resolve_env("SOMA_AGENT_HUB_AIRFLOW_JWT") or resolve_env("SOMA_AGENT_HUB_BEARER_TOKEN")


def _build_token() -> str:
    if not STATIC_TOKEN:
        raise RuntimeError("Missing bearer token. Set SOMA_AGENT_HUB_AIRFLOW_JWT (or SOMA_AGENT_HUB_BEARER_TOKEN).")
        return STATIC_TOKEN
