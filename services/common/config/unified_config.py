    ...
    def _create_default_config(self) -> dict[str, Any]:
        return {
            ...
            "environments": {
                ...
                "prod": {
                    "resource_profile": "cloud_medium",
                    "memory_limit_gb": 0,
                    "cpu_limit": 0,
                },
                "prod_ha": {
                    "resource_profile": "cloud_large",
                    "memory_limit_gb": 0,
                    "cpu_limit": 0,
                },
            },
    ...
    def _create_env_config(self) -> EnvironmentConfig:
        ...
        for service_name, service_config in self.config["services"].items():
            ...
            services[service_name] = ServiceConfig(
                ...
                cpu_limit=env_service_config.get(
                    "cpu_limit", service_config["cpu_limit"]
                ),
                memory_limit=env_service_config.get(
        ...
        return EnvironmentConfig(
            ...
            resource_profile=ResourceProfile(
                env_config.get("resource_profile", "local_10gb")
            ),
