nified Configuration System for SomaAgentHub

 module provides a centralized configuration management system that replaces
 multiple overlapping configuration patterns found throughout the codebase.

 services should import configuration from this module:
    ...
    from .base_config import get_config, BaseConfig

    -------------------------------------------------------------------------
    lper for service‑specific configuration
    -------------------------------------------------------------------------
