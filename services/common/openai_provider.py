...
class OpenAIProvider:
    ...
    def __init__(
        ...
        # Explicitly use resolve_env directly to avoid nested function issue
        self.api_key = (
            api_key
            or resolve_env("OPENAI_API_KEY")
            or resolve_env("SOMA_AGENT_HUB_OPENAI_API_KEY")
        )
        if not self.api_key:
        ...
        self.client = AsyncOpenAI(
            ...
            organization=organization or resolve_env("OPENAI_ORGANIZATION"),
            base_url=base_url or resolve_env("OPENAI_BASE_URL"),
        )
