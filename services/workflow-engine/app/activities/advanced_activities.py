...
class AdvancedActivities:
    ...
    @activity.defn
    async def retrieve_memory_context(self, role_id: str, query: str, limit: int = 5, context: Dict[str, Any] = None) -> List[str]:
        ...
        async with get_async_session() as session:
            import uuid
            from services.common.models.memory import MemoryOperationRecord, MemoryOperationType
            ...
            try:
                ...
                op_record = MemoryOperationRecord(
                    ...
                    request_summary={"query": query, "role_id": role_id, "limit": limit},
    ...
    @activity.defn
    async def store_memory_experience(self, role_id: str, content: str, metadata: Dict[str, Any], context: Dict[str, Any] = None):
        ...
        async with get_async_session() as session:
            ...
            try:
                ...
                op_record = MemoryOperationRecord(
                    ...
                    request_summary={"role_id": role_id, "metadata": metadata}, # Content might be too large
    ...
    async def fetch_capsule(self, capsule_name: str, capsule_version: str) -> Dict[str, Any]:
        ...
        async with get_async_session() as session:
            stmt = select(CapsuleDefinition).where(CapsuleDefinition.name == capsule_name, CapsuleDefinition.version == capsule_version)
