...
from services.common.models.role import RoleDefinition, AgentBinding, AgentSessionBinding, AgentSessionStatus
...
class AgentActivities:
    ...
    @activity.defn
    async def execute_agent(self, role_id: str, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        async with get_async_session() as session:
            ...
            session_binding = AgentSessionBinding(
                ...
                workflow_instance_id=uuid.UUID(workflow_instance_id) if workflow_instance_id else None,
                node_execution_id=uuid.UUID(node_execution_id) if node_execution_id else None,
            ...
            try:
                ...
                if role_def.expected_behavior:
                    system_prompt += f"Expected Behavior: {role_def.expected_behavior}\n"
