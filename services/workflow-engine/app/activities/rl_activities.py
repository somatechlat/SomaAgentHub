...
class RLActivities:
    ...
    async def record_trajectory_step(
        ...
        logger.info(f"Recording trajectory step for {node_id} in workflow {workflow_id}")
    ...
    @activity.defn
    async def finalize_trajectory(self, workflow_id: str, final_outcome: Dict[str, Any], context: Dict[str, Any]) -> str:
