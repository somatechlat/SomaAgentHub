        on-aware routing for multi-region deployments.

        es requests to the appropriate regional backend based on:
                        ...
                        def get_client_region(self, request: Request) -> Region:
                            ...
                            Args:
                                ...
                                Returns:
                                    ...
                                    eck for forwarded IP (behind load balancer)
                    ...
                    Args:
                        ...
                        Returns:
                            ...
                            if not user_metadata:
                                ...
                                eck for explicit data residency requirement
                                                                ...
                                                                def validate_data_residency(self, user_id: str, target_region: Region) -> bool:
                                                                    ...
                                                                    Args:
                                                                        ...
                                                                        Returns:
                                                                            ...
                                                                            """
         production, lookup user's data residency requirements from database
         r now, implement basic EU/US separation

                                                                            user_data_zone = self._get_user_data_zone(user_id)
                                                                            target_data_zone = REGION_CONFIG[target_region]["data_zone"]

         users must stay in EU
                                                                            if (
                                                                                                ...
                                                                                                Returns:
                                                                                                    ...
                                                                                                    for region, config in REGION_CONFIG.items():
                                                                                                        if not config["enabled"]:
                                                                                                            ...
                                                                                                            AL health check: ping regional endpoint
                                                                                                            try:
                                                                                                                endpoint_val = config["endpoint"]
                    ...
                    async def route_request(request: Request, user_id: str | None = None) -> str:
                        ...
                        Args:
                            ...
                            Returns:
                                ...
                                if user_id:
                                    e user's data residency requirements
