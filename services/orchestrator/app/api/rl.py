...
@router.post(
    "/pipelines",
    response_model=ReasoningPipelineSpecResponse,
...
@router.post(
    "/games", response_model=GameSpecResponse, status_code=status.HTTP_201_CREATED
)
...
@router.post(
    "/trajectories",
    response_model=TrajectoryRecordResponse,
    status_code=status.HTTP_201_CREATED,
)
...
@router.post(
    "/exports", response_model=RLExportJobResponse, status_code=status.HTTP_201_CREATED
)
