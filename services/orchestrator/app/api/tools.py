...
def create_tool_definition(
    ...
    return service.create_tool_definition(tool_create)
...
def get_tool_definition(
    ...
    tool = service.get_tool_definition(tool_id, x_tenant_id)
    if not tool:
        raise HTTPException(
...
def list_tool_definitions(
    ...
    return service.list_tool_definitions(x_tenant_id, tool_type)
...
def create_mcp_server(
    ...
    return service.create_mcp_server(server_create)
...
def get_mcp_server(
    ...
    server = service.get_mcp_server(server_id, x_tenant_id)
    if not server:
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
