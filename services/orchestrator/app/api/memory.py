...
from services.common.models.memory import (
    ...
    MemoryBindingSpecResponse,
    MemoryOperationRecordCreate,
    MemoryOperationRecordResponse,
)
...
@router.post(
    "/bindings",
    response_model=MemoryBindingSpecResponse,
...
@router.post(
    "/operations",
    response_model=MemoryOperationRecordResponse,
    status_code=status.HTTP_201_CREATED,
)
...
@router.get(
    "/operations/workflow/{workflow_instance_id}",
    response_model=list[MemoryOperationRecordResponse],
)
