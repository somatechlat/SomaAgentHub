...
from services.common.models.capsule_complete import (
    CapsuleDefinition, CapsuleInstance, CapsuleStatus, CapsuleScope,
    CapsuleDefinitionCreate, CapsuleDefinitionResponse,
    CapsuleInstanceCreate, CapsuleInstanceResponse
)
...
class CapsuleService:
    ...
    async def create_definition(
        self,
        capsule_data: CapsuleDefinitionCreate
    ...
    async def get_definition(
        ...
        capsule_id: UUID,
        tenant_id: UUID
    ) -> Optional[CapsuleDefinitionResponse]:
        """
    ...
    async def list_definitions(
        ...
        async with get_async_session() as session:
           ...
           stmt = stmt.order_by(
                CapsuleDefinition.name.asc(),
                CapsuleDefinition.version.desc()
            )
    ...
    async def create_instance(
        self,
        instance_data: CapsuleInstanceCreate
        ...
        async with get_async_session() as session:
            ...
            def_stmt = select(CapsuleDefinition).where(
                and_(
                    ...
                    CapsuleDefinition.version == instance_data.capsule_definition_version
                )
            )
    ...
    async def get_instance(
        ...
        instance_id: UUID,
        tenant_id: UUID
    ) -> Optional[CapsuleInstanceResponse]:
        """
    ...
    async def resolve_instance(
        ...
        async with get_async_session() as session:
            ...
            config = {
                "persona": {
                    "default_persona_ref_id": str(definition.default_persona_ref_id) if definition.default_persona_ref_id else None,
