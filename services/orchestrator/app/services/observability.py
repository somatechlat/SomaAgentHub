        rehensive observability stack with OpenTelemetry, structured logging, and metrics.
         ...
         module provides:
             ...
             ntext variables for distributed tracing
            ...
            if otlp_endpoint:
                ...
                class StructuredJSONFormatter(logging.Formatter):
                    ...
                    def format(self, record: logging.LogRecord) -> str:
                        ...
                        d exception info if present
                        if record.exc_info:
                            log_data["exception"] = self.formatException(record.exc_info)

                            d extra fields from record
                                        ...
                                        if attributes:
                                            ...
                                            def setup_logging():
                                                ...
                                                for handler in root_logger.handlers[:]:
                                                    ...
                                                    d structured JSON handler
                                                    handler = logging.StreamHandler()
                                                    formatter = StructuredJSONFormatter()
                                                    handler.setFormatter(formatter)
                                                    root_logger.addHandler(handler)

                                                    ppress noisy loggers
