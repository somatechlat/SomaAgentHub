...
class HITLService:
    ...
    async def assign_reviewer(
        self, assignment_create: HumanReviewerAssignmentCreate
    ) -> HumanReviewerAssignment:
    ...
    async def list_assignments_for_session(
        self, session_id: UUID, tenant_id: UUID
    ) -> list[HumanReviewerAssignment]:
    ...
    async def record_decision(
        self, decision_create: HumanDecisionRecordCreate
    ) -> HumanDecisionRecord:
