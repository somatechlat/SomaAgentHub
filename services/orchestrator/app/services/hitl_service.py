...
class HITLService:
    ...
    async def assign_reviewer(self, assignment_create: HumanReviewerAssignmentCreate) -> HumanReviewerAssignment:
    ...
    async def get_assignment(self, assignment_id: UUID, tenant_id: UUID) -> Optional[HumanReviewerAssignment]:
    ...
    async def list_assignments_for_session(self, session_id: UUID, tenant_id: UUID) -> List[HumanReviewerAssignment]:
    ...
    async def record_decision(self, decision_create: HumanDecisionRecordCreate) -> HumanDecisionRecord:
    ...
    async def get_decisions_for_session(self, session_id: UUID, tenant_id: UUID) -> List[HumanDecisionRecord]:
