...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "memory_bindings", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "agent_metadata", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "agents", postgresql.ARRAY(postgresql.UUID(as_uuid=True)), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_graph_workflows_tenant_id"),
        "graph_workflows",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_human_review_sessions_tenant_id"),
        "human_review_sessions",
        ["tenant_id"],
        unique=False,
    )
