...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "principal_type",
            sa.Enum("USER", "SERVICE", "SYSTEM", name="principaltype"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_external_refs_tenant_id"), "external_refs", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_external_refs_system"), "external_refs", ["system"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("LOW", "NORMAL", "HIGH", "CRITICAL", name="taskpriority"),
            nullable=False,
        ),
        ...
        sa.Column(
            "root_workflow_instance_id", postgresql.UUID(as_uuid=True), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_task_status_history_timestamp"),
        "task_status_history",
        ["timestamp"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("DRAFT", "ACTIVE", "DEPRECATED", name="capsulestatus"),
            nullable=False,
        ),
        ...
        sa.Column(
            "role_overrides", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "allowed_tools", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "prohibited_tools", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "allowed_mcp_servers",
        ...
        sa.Column(
            "tool_risk_profile", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column("max_wall_clock_seconds", sa.Integer(), nullable=False),
        sa.Column("max_concurrent_nodes", sa.Integer(), nullable=True),
        sa.Column(
            "allowed_runtimes", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "resource_profile", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "allowed_domains", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "blocked_domains", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "egress_mode",
            sa.Enum(
                "DENY_ALL", "ALLOW_LIST", "ALLOW_ALL_WITH_MONITORING", name="egressmode"
            ),
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column(
            "default_hitl_mode",
            sa.Enum(
                "NEVER", "ON_HIGH_RISK", "ALWAYS_ON_CRITICAL_NODES", name="hitlmode"
            ),
            nullable=False,
        ),
        sa.Column(
            "risk_thresholds", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column("max_pending_hitl", sa.Integer(), nullable=True),
        sa.Column("rl_export_allowed", sa.Boolean(), nullable=False),
        sa.Column(
            "rl_export_scope",
            sa.Enum("ANONYMIZED_ONLY", "PSEUDONYMIZED", "FULL", name="rlexportscope"),
            nullable=False,
        ),
        sa.Column(
            "rl_excluded_fields",
    ...
    op.create_index(
        op.f("ix_capsule_definitions_tenant_id"),
        "capsule_definitions",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_capsule_definitions_name"),
        "capsule_definitions",
        ["name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_capsule_definitions_status"),
        "capsule_definitions",
        ["status"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("tenant_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column(
            "capsule_definition_id", postgresql.UUID(as_uuid=True), nullable=False
        ),
        sa.Column("capsule_definition_version", sa.Integer(), nullable=False),
        sa.Column(
            "scope",
            sa.Enum("TASK", "WORKFLOW", "NODE", "ROLE", name="capsulescope"),
            nullable=False,
        ),
        ...
        sa.Column(
            "effective_config", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_capsule_instances_tenant_id"),
        "capsule_instances",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_capsule_instances_capsule_definition_id"),
        "capsule_instances",
        ["capsule_definition_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_capsule_instances_scope"), "capsule_instances", ["scope"], unique=False
    )
    op.create_index(
        op.f("ix_capsule_instances_created_at"),
        "capsule_instances",
        ["created_at"],
        unique=False,
    )
