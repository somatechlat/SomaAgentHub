        ...
        Central registry for all tool adapters in the ecosystem:
            ...
            class ToolInfo:
                ...
                class ToolAdapter(Protocol):
                    ...
                    pability dispatch methods will be resolved dynamically; protocol enforces health.
                    ...
                    class ToolRegistry:
                        ...
                        def __init__(self, adapters_dir: str = "services/tool-service/adapters"):
                            ...
                            def _discover_adapters(self) -> None:
                                ...
                                nually register known adapters
                                ...
                                if tool_info.requires_auth and not credentials:
                                    ...
                                    if credentials:
                                        adapter = adapter_class(**credentials)
                                            ...
                                            ructural Protocol compliance check (runtime) – raises if incompatible
                                            if not isinstance(adapter, ToolAdapter):  # type: ignore[arg-type]
                                            ovide a descriptive error for developers extending adapters.
                                            raise TypeError(
