...
class SlackAdapter:
    ...
    def __init__(self, bot_token: str | None = None):
        self.bot_token = bot_token or resolve_env("SLACK_BOT_TOKEN")
        ...
        if not self.bot_token:
            logger.warning("SLACK_BOT_TOKEN not found. API calls will fail.")
    ...
    def set_user_status(
        ...
        return self._request("POST", "users.profile.set", json={"profile": profile})
    ...
    def build_section_block(
        text: str, markdown: bool = True, accessory: dict[str, Any] | None = None
    ) -> dict[str, Any]:
    ...
    def build_button_element(
        ...
        action_id: str,
        value: str | None = None,
        style: str | None = None,  # "primary", "danger"
    ) -> dict[str, Any]:
