...
class DiscordAdapter:
    ...
    def create_thread(
        ...
        """Create a thread."""
        data = {"name": name, "auto_archive_duration": auto_archive_duration}
    ...
    def create_project_workspace(
        self, guild_id: str, project_name: str, channels: list[str] | None = None
    ) -> dict[str, Any]:
        """
        ...
        category = self.create_channel(
            guild_id=guild_id, name=project_name, type=4  # Category
        )
