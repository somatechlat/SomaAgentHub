...
class ConfluenceAdapter:
    ...
    def search_pages(self, cql: str, limit: int = 25) -> list[dict[str, Any]]:
        """
    ...
    def create_documentation_space(
        ...
        project_name: str,
        description: str,
        initial_pages: list[dict[str, str]] | None = None,
    ) -> dict[str, Any]:
        """
        ...
        """
        # Create space
        space_key = project_name.upper().replace(" ", "").replace("-", "")[:10]  # Max 10 chars
    ...
    def create_api_documentation_page(
        self, space_key: str, api_name: str, endpoints: list[dict[str, Any]]
    ) -> dict[str, Any]:
        """
        ...
        page = self.create_page(space_key=space_key, title=f"{api_name} API", body=body)
