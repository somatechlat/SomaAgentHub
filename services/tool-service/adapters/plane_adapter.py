        ...
        e.so is a project management platform. This adapter provides:
                            ...
                            Returns:
                                ...
                                def get_project(self, project_id: str) -> dict[str, Any]:
                                    ...
                                    def list_projects(self) -> list[dict[str, Any]]:
                                        ...
                                        return self._request("GET", f"workspaces/{self.workspace_slug}/projects/")
                                                    ...
                                                    if state:
                                                        ...
                                                        if assignees:
                                                            ...
                                                            if labels:
                                                                ...
                                                                def update_issue(self, project_id: str, issue_id: str, **kwargs) -> dict[str, Any]:
                                                                                                                                            ...
                                                                                                                                            self, project_id: str, name: str, color: str = "#3f76ff"
                                                                                                                                                ...
                                                                                                                                                def list_labels(self, project_id: str) -> list[dict[str, Any]]:
                                                                                                                                                    ...
                                                                                                                                                    def list_workspace_members(self) -> list[dict[str, Any]]:
                                                                                                                                                        ...
                                                                                                                                                        return self._request("GET", f"workspaces/{self.workspace_slug}/members/")
                                                                                                                                                                                                ...
                                                                                                                                                                                                self, name: str, identifier: str, template: str = "agile"
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    Args:
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        Returns:
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            eate default labels based on template
                                                                                                                                                                                                            if template == "agile":
                                                                                                                                                                                                                labels = [
