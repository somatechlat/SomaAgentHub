...
class AzureAdapter:
    ...
    def create_vm(
        ...
        image_reference: dict[str, str] | None = None,
    ) -> dict[str, Any]:
    ...
    def list_vms(self, resource_group: str | None = None) -> list[dict[str, Any]]:
    ...
    def bootstrap_infrastructure(
        ...
        return {"resource_group": rg, "storage_account": storage}
