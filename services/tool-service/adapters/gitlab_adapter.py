...
# ============================================================================
    ...
    def protect_branch(self, project_id: str, branch_name: str) -> dict[str, Any]:
                                                                        """Protect a branch."""
                                                                        encoded_id = requests.utils.quote(project_id, safe="")
                                                                        _encoded_branch = requests.utils.quote(branch_name, safe="")
                                                                        return self._request(
                                                                        "POST",
                                                                        f"projects/{encoded_id}/protected_branches",
...
# Protect main branch
                                                                                                                                            ...
                                                                                                                                            return {"project": project, "ci_configured": ci_config is not None}
