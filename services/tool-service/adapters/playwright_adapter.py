        ...
        mates web UIs for tools without APIs:
           ...
           def go_back(self) -> None:
                                                                                                                   ...
                                                                                                                   Args:
                                                                                                                       ...
                                                                                                                       Returns:
                                                                                                                           ...
                                                                                                                           if path:
                                                                                                                               ...
                                                                                                                               def screenshot_element(self, selector: str, path: str | None = None) -> bytes:
                                                                                                                                   ...
                                                                                                                                   if path:
                                                                                                                                       ...
                                                                                                                                       username: str,
                                                                                                                                       password: str,
                                                                                                                                       post_login_selector: str | None = None,
                                                                                                                                       ) -> None:
                                                                                                                                           """
                                                                                                                                           Perform login.
                                                                                                                                                                   ...
                                                                                                                                                                   def extract_table(self, table_selector: str) -> list[list[str]]:
                                                                                                                                                                       ...
                                                                                                                                                                       Args:
                                                                                                                                                                           ...
                                                                                                                                                                           Returns:
                                                                                                                                                                               ...
                                                                                                                                                                               vaScript to extract table data
                                                                                                                                                                               script = f"""
            ...
            if step.get("wait_ms"):
                ...
                if __name__ == "__main__":
                    ample: Automate form submission
