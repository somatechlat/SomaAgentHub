...
"services.common.deployment.deployment_strategy"
)
except ImportError:  # pragma: no cover - best effort, tests can run without this module
get_deployment_config = None
DeploymentFactory = None
else:
get_deployment_config = deployment_module.get_deployment_config
DeploymentFactory = deployment_module.DeploymentFactory
...
if not get_deployment_config or not DeploymentFactory:
print("⚠️ Deployment Strategy module unavailable")
return False
