...
from services.common.opa_client import OPAClient, get_opa_client
...
def test_health_check(monkeypatch):
    ...
    monkeypatch.setattr(httpx, "AsyncClient", lambda *a, **kw: httpx.AsyncClient(transport=transport_fail))
