...
class RedisConfig:
                                ...
                                class Settings(BaseSettings):
                                    ...
                                    clickhouse_host_raw: str | None = Field(
                                        default=runtime_default(
                                            "clickhouse",
                                            "clickhouse.soma-infra.svc.cluster.local",
                                        ),
                                        validation_alias=AliasChoices(
        ...
        model_config = (
            SettingsConfigDict(env_prefix="SOMA_AGENT_HUB_", extra="allow")
            @ cached_property
        )
    ...
    def etcd(self) -> EtcdConfig:
        return EtcdConfig(
            endpoint=self.etcd_endpoint_raw
        )
