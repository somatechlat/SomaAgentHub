...
Before ANY coding, analysis, planning, or documentation, you MUST follow these Vibe Coding Rules exactly, with ZERO exceptions.
...
- [Engineering Playbook](docs/development-manual/engineering-playbook.md)
- [Coding Standards](docs/development-manual/coding-standards.md)
- [VIBE Violations Audit](VIBE_VIOLATIONS_AUDIT_REPORT.md)
